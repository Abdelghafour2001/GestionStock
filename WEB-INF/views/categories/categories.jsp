...
<body id="page-top">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<c:url value="/categories/new"/>"><i class="fas fa-plus"><fmt:message key="common.ajouter" /></i></a></li>
								...
								<table class="table table-bordered" id="dataTable" width="100%"
									...
									<tbody>
										<c:forEach items="${categories }" var="category">
											<tr>
												<td>${category.getCodeCategorie() }</td>
												<td>${category.getDesignation() }</td>
												
												<td>&nbsp;&nbsp;
												<c:url value="/categories/modifier/${category.getIdCategory() }" var="editclurl"/>
												<a class="btn btn-primary" href="${editclurl }"><i class="fas fa-edit"></i></a>
												<c:url value="/categories/supprimer/${category.getIdCategory() }" var="deleteclurl"/>
												<a class="btn btn-danger" data-toggle="modal" data-target="#deleteModal${category.getIdCategory() }" href="#"><i class="fas fa-trash-alt"></i></a></td>
														<!-- Delete modal -->
		<div class="modal fade" id="deleteModal${category.getIdCategory() }" tabindex="-1" role="dialog"
