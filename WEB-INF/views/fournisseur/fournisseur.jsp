...
<body id="page-top">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<c:url value="/fournisseur/new"/>"><i class="fas fa-plus"><fmt:message key="common.ajouter" /></i></a></li>
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">
								<fmt:message key="common.listefournisseur" />
							</h6>
						</div>
						<div class="card-body">
									...
									<tbody>
										<c:forEach items="${fournisseurs }" var="fournisseur">
											<tr>
												...
												<td>&nbsp;&nbsp;
												<c:url value="/fournisseur/modifier/${fournisseur.getIdFournisseur() }" var="editclurl"/>
												<a class="btn btn-primary" href="${editclurl }"><i class="fas fa-edit"></i></a>
												<c:url value="/fournisseur/supprimer/${fournisseur.getIdFournisseur() }" var="deleteclurl"/>
												<a class="btn btn-danger" data-toggle="modal" data-target="#deleteModal${fournisseur.getIdFournisseur() }" href="#"><i class="fas fa-trash-alt"></i></a></td>
														<!-- Delete modal -->
