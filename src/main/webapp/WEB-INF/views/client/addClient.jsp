				...
				<div class="card shadow mb-6" style="margin:0px 40px">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">
							<fmt:message key="common.newcl" />
						</h6>
					</div>
					<!-- /.container-fluid -->
					<div class="card-body " style="margin:0px 20px">
					<c:url value="/client/enregistrer" var="urlnewcl"/>
						<f:form  modelAttribute="client" action="${urlnewcl }" method="POST" enctype="multipart/form-data">
							<div class="mb-3">
