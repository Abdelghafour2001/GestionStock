...
<body id="page-top">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<c:url value="/client/new"/>"><i class="fas fa-plus"><fmt:message key="common.ajouter" /></i></a></li>
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">
								<fmt:message key="common.listeclient" />
							</h6>
						</div>
						<div class="card-body">
									...
									<tbody>
										<c:forEach items="${clients }" var="client">
											<tr>
												...
												<td>&nbsp;&nbsp;
												<c:url value="/client/modifier/${client.getIdClient() }" var="editclurl"/>
												<a class="btn btn-primary" href="${editclurl }"><i class="fas fa-edit"></i></a>
												<c:url value="/client/supprimer/${client.getIdClient() }" var="deleteclurl"/>
												<a class="btn btn-danger" data-toggle="modal" data-target="#deleteModal${client.getIdClient() }" href="#"><i class="fas fa-trash-alt"></i></a></td>
														<!-- Delete modal -->
